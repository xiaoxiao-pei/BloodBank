...
$BloodAmountBefore =$row ['BloodAmount'];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($validate) {
            ...
            if ($result) {
                ...
                // update blood amount in blood table
                $query = "UPDATE blood 
                SET BloodVolume = BloodVolume - $BloodAmountBefore + $bloodAmount
                where BloodType IN (
                    SELECT BloodType
                    FROM  donor
                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6 ">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                ...
                                <h2 class="text-uppercase text-center mb-5">Update Donation</h2>
                                ...
                                <div class="form">
                                    <form action="" method="post" name="createDonation">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="text" name="donationid" class="form-control form-control-lg" placeholder="Donation ID" value="<?= $row['DonationID'] ?>" />
                                            <span class="error" style="color:#FF0000;"><?php echo $donationidErr; ?></span> <br />

                                        </div>

                                        <div class="form-outline mb-4">
                                            <input type="text" class="form-control form-control-lg" name="donorid" placeholder="Donor ID" value="<?= $row['DonorID'] ?>" />
                                            <span class="error" style="color:#FF0000;"><?php echo $donoridErr; ?></span> <br />
                                        </div>

                                        <div class="form-outline mb-4">
                                            <input type="text" class="form-control form-control-lg" name="bloodAmount" placeholder="Blood Amount" value="<?= $row['BloodAmount'] ?>" />
                                            <span class="error" style="color:#FF0000;"><?php echo $bloodAmountErr; ?></span> <br />
                                        </div>

                                        <div class="form-outline mb-4">
                                            <input type="date" class="form-control form-control-lg" name="donationDate" placeholder="Donation Date" value="<?=  $row['DonateDate'] ?>" />
                                        ...
                                        <div class="d-flex justify-content-center d-inline">
                                            <input type="submit" value="Update" class="px-3">
                                            &nbsp&nbsp&nbsp
                                            <div>
                                        ...
                                        <div class="d-flex justify-content-center d-inline mt-3">
                                            ...
                                            <?php if ($_SESSION['successMsg'] && $_SERVER["REQUEST_METHOD"] == "POST") {
                                                ...
                                                echo "<h4>Unsuccessful update, please try again.<h4>";
                                            }
                                            ?>
